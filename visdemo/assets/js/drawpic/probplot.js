...
(function() {
    ...
    $.get('json/Mobility.json', function(Mobility) {
        ...
        //     'PuChuan', 'GuDong', 'ZhongHe', 'TengYue',
        ...
        // 数组去重
        days = [...new Set(TownName_from_json)];
        days.sort()
            // console.log(TownName_from_json)
        hours = [...new Set(TargetName_from_json)];
        // console.log(TargetName_from_json)
        hours.sort()

        // var TownName_from_json = [];
        // var TargetName_from_json = [];
        // var Probability_from_json = [];
        ...
        Mobility.Mobility.forEach(element => {
            ...
            days.findIndex(function(days_value, days_index) {
                ...
                // TownName_from_json.push(element['TownName']);
                // TargetName_from_json.push(element['TargetName']);
                // Probability_from_json.push(element['Probability']);
            data_set_from_json.push(agency)
        });
        // console.log(TownName_from_json.length)
        // console.log(TargetName_from_json.length)
        // console.log(data_set_from_json)
        // console.log(Probability_from_json.length)
        // var data = [
        //     [0, 0, 7],
        //     [0, 1, 3],
        //     [0, 2, 8],
